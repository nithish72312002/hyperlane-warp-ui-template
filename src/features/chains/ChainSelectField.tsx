...
const styles = {
  base: 'w-36 px-2.5 py-2 relative -top-1.5 flex items-center justify-between text-sm bg-white rounded-sm border border-blue-300 outline-none transition-colors duration-500',
