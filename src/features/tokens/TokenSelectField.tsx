...
const styles = {
  base: 'mt-1.5 w-full px-2.5 py-2 flex items-center justify-between text-sm rounded-sm border border-blue-300 outline-none transition-colors duration-500',
